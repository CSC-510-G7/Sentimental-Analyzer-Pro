...
class AudioAnalyzer:
    ...
    # method takes in param file path of .wav
    # audio file and returns corresponding text
    ...
    # methods takes in param sentence text and
    #  returns python dictionary containing pos, neg, neutral sentiment
